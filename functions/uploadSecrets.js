...
const uploadSecrets = async () => {
  ...
  const privateKey = "858b9a5cb8d798448c1382c800ab424ba232c75a3933e45fbf96192689169625"; // fetch PRIVATE_KEY
  if (!privateKey)
    throw new Error(
      "private key not provided - check your environment variables"
    );

  const rpcUrl = "https://eth-sepolia.g.alchemy.com/v2/jHrjpZkIL5Jp7VUy0IAXyqcXwjG3fgDt";
